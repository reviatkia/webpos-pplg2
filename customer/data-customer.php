        ...
        <div class="card-body table-responsive p-3">
          <table class="table table-hover text-nowrap" id="tblData">
            ...
            <tbody>
              <?php
              $no = 1;
              $customer = getData("SELECT * FROM tbl_costumer");
              foreach ($customer as $s): ?>
                <tr>
                  ...
                  <td><?= $s['alamat'] ?></td>
                  <td>
                    <a href="edit-costumer.php?id=<?= $s['id_costumer'] ?>" class="btn btn-sm btn-warning"><i
                        class="far fa-edit"></i></a>
                    <a href="del-costumer.php?id=<?= $s['id_costumer'] ?>"
