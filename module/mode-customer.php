...
function insert($data)
{
  ...
  // variable 
  $sqlCustomer = "INSERT INTO tbl_costumer VALUES (null, '$nama', '$telpon','$alamat')";
...
function update($data)
{
  ...
  $sqlCustomer = "UPDATE tbl_costumer SET nama = '$nama', telp = '$telpon', alamat = '$alamat' WHERE id_costumer = '$id' ";
  mysqli_query($koneksi, $sqlCustomer);
  return mysqli_affected_rows($koneksi);
}